        ...
        <div className="contentSpacing">
            ...
            <div className="recommendation__section">
                <div className="recommendation__header">
                    <h2>Good {new Date().getHours()<12 && "morning 🙏"} {new Date().getHours()>=12 || new Date().getHours()<16 ? "afternoon 😎":null} {new Date().getHours()>16 || new Date().getHours()<20 ? "evening 🌦":null} {new Date().getHours()>20 ?  "night 😴":null} </h2>
                </div>
